...
restartOdoo(){
    ...
    kill $(lsof -t -i:$1)
    cd $2
    python3 odoo-bin --addons-path="$3,$4"
}
...
alias ${ODOO_PROJECT_NAME}_restart='restartOdoo $ODOO_PROJECT_PORT $ODOO_PROJECT_PATH $ODOO_ADDONS_PATH $ODOO_CUSTOM_ADDONS_PATH'
