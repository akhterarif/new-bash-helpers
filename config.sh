...
SYSTEM_USER_FULL_NAME="Akhter-uz-zaman"
SYSTEM_USER_EMAIL="arif.cse28@gmail.com"
SYSTEM_USER_NAME="digicon"
SYSTEM_ROOT_FOLDER="/home/digicon"
SYSTEM_ROOT_GIT_REPO_FOLDER="$SYSTEM_ROOT_FOLDER/Gitrepos"
BASH_HELPER_GIT_FOLDER="$SYSTEM_ROOT_GIT_REPO_FOLDER/bash-helpers"

LATEST_PYCHARM_VERSION="pycharm-community"
...
if [ -f $BASH_HELPER_GIT_FOLDER/odoo.sh ]; then
    . $BASH_HELPER_GIT_FOLDER/odoo.sh
fi;
